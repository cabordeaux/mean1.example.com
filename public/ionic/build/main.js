...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__articles_articles__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_article_article__ = __webpack_require__(33);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var UserUpdatePage = /** @class */ (function () {
    function UserUpdatePage(navCtrl, navParams, userProvider, formBuilder) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.userProvider = userProvider;
        this.formBuilder = formBuilder;
    ...
    UserUpdatePage.prototype.ionViewDidLoad = function () {
        this.getUser(this.navParams.data.id);
    };
    UserUpdatePage.prototype.getUser = function (id) {
        var _this = this;
        this.userProvider.getUser(id).subscribe(function (response) {
            _this.myUser = response.user;
        });
    };
    UserUpdatePage.prototype.response = function (response) {
        if (response.success === false) {
            this.errors = response.error.errors;
            this.errorMessage = response.error._message;
        }
    ...
    UserUpdatePage.prototype.updateUser = function () {
        var _this = this;
    ...
    UserUpdatePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-user-update',template:/*ion-inline-start:"/home/clovis/ionic-cms/src/pages/user-update/user-update.html"*/'<!--\n  Generated template for the UserUpdatePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>edit user</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-content padding>\n    <form *ngIf="myUser" [formGroup]="user" (ngSubmit)="updateUser()">\n        <ion-input type="hidden" formControlName="_id" value="{{ myUser._id "></ion-input>\n      <ion-list>\n\n        <ion-item no-lines class="hide"></ion-item>\n\n        <ion-list-header no-lines class="alert alert-error no-lines" *ngIf="errorMessage">{{ errorMessage }}</ion-list-header>\n\n        <ion-item no-lines [ngClass]="{\'has-error\':errors.username}">\n          <ion-label floating>Username</ion-label>\n          <ion-input type="text" formControlName="username"></ion-input>\n        </ion-item>\n\n        <ion-item no-lines class="error no-lines" *ngIf="errors.username">{{errors.username.message}}</ion-item>\n\n        <ion-item no-lines [ngClass]="{\'has-error\':errors.email}">\n          <ion-label floating>Email</ion-label>\n          <ion-input type="email" formControlName="email"></ion-input>\n        </ion-item>\n\n        <ion-item no-lines class="error no-lines" *ngIf="errors.email">{{errors.email.message}}</ion-item>\n\n        <ion-item no-lines >\n          <ion-label floating>First Name</ion-label>\n          <ion-input type="text" formControlName="first_name"></ion-input>\n        </ion-item>\n\n        <ion-item no-lines class="error no-lines" *ngIf="errors.first_name">{{errors.first_name.message}}</ion-item>\n\n        <ion-item no-lines >\n          <ion-label floating>Last Name</ion-label>\n          <ion-input type="text" formControlName="last_name"></ion-input>\n        </ion-item>\n\n        <ion-item no-lines class="error no-lines" *ngIf="errors.last_name">{{errors.last_name.message}}</ion-item>\n\n        <ion-item no-lines class="hide"></ion-item>\n      </ion-list>\n\n      <button ion-button float-right type="submit">Submit</button>\n\n    </form>\n  </ion-content>\n\n</ion-content>\n'/*ion-inline-end:"/home/clovis/ionic-cms/src/pages/user-update/user-update.html"*/,
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/home/clovis/ionic-cms/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Home</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <h3>My CMS</h3>\n\n  <button ion-button secondary menuToggle>Toggle Menu</button>\n</ion-content>\n'/*ion-inline-end:"/home/clovis/ionic-cms/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */]])
    ], HomePage);
    return HomePage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_user_update_user_update__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_user_delete_user_delete__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_articles_articles__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_article_article__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_article_create_article_create__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_article_edit_article_edit__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_article_delete_article_delete__ = __webpack_require__(108);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__pages_user_update_user_update__["a" /* UserUpdatePage */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_articles_articles__ = __webpack_require__(55);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/clovis/ionic-cms/src/app/app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n'/*ion-inline-end:"/home/clovis/ionic-cms/src/app/app.html"*/
        }),
...
var ArticleProvider = /** @class */ (function () {
    function ArticleProvider(http) {
        this.http = http;
        this.url = 'https://clovisbordeaux.com/api/articles';
    }
...
var UserProvider = /** @class */ (function () {
    function UserProvider(http) {
        this.http = http;
        this.url = 'https://clovisbordeaux.com/api/users';
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_user_user__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__user_update_user_update__ = __webpack_require__(110);
...
var UserPage = /** @class */ (function () {
    ...
    UserPage.prototype.toUserUpdate = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__user_update_user_update__["a" /* UserUpdatePage */], { id: this.user._id });
    };
    ...
    UserPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-user',template:/*ion-inline-start:"/home/clovis/ionic-cms/src/pages/user/user.html"*/'<!--\n  Generated template for the UserPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>user</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-card *ngIf="user">\n    <ion-avatar item-start>\n      <img src="{{ user.gravatarUrl }}">\n    </ion-avatar>\n    <h2>\n      <span *ngIf="user.first_name">\n        {{ user.first_name }}\n      </span>\n      <span *ngIf="user.last_name">\n        {{ user.last_name }}\n      </span>\n    </h2>\n    <p>{{ user.email }}</p>\n    <p>{{ user.username }}</p>\n  </ion-card>\n<ion-fab right bottom>\n  <button ion-fab color = "light">\n    <ion-icon name="arrow-dropleft"></ion-icon>\n  </button>\n  <ion-fab-list side="left">\n\n    <button ion-fab color="primary" (click)="toUserUpdate()">\n      <ion-icon name="create"></ion-icon>\n\n    </button>\n\n    <button ion-fab color="danger" (click)="toUserDelete()">\n        <ion-icon name="trash"></ion-icon>\n      </button>\n\n  </ion-fab-list>\n</ion-fab>\n\n</ion-content>\n'/*ion-inline-end:"/home/clovis/ionic-cms/src/pages/user/user.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_3__providers_user_user__["a" /* UserProvider */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__article_delete_article_delete__ = __webpack_require__(108);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ArticlePage = /** @class */ (function () {
    ...
    ArticlePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-article',template:/*ion-inline-start:"/home/clovis/ionic-cms/src/pages/article/article.html"*/'<!--\n  Generated template for the ArticlePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n\n    <ion-title *ngIf="article">\n\n    {{ article.title }}\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n  <ion-content padding>\n    <div *ngIf="article">\n\n      {{ article.body }}\n    </div>\n  <ion-fab right bottom>\n    <button ion-fab color = "light">\n      <ion-icon name="arrow-dropleft"></ion-icon>\n    </button>\n  <ion-fab-list side="left">\n\n      <button ion-fab color="primary" (click)="toArticleEdit()">\n        <ion-icon name="create"></ion-icon>\n\n      </button>\n\n      <button ion-fab color="danger" (click)="toArticleDelete()">\n          <ion-icon name="trash"></ion-icon>\n        </button>\n\n    </ion-fab-list>\n  </ion-fab>\n\n  </ion-content>\n'/*ion-inline-end:"/home/clovis/ionic-cms/src/pages/article/article.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__article_create_article_create__ = __webpack_require__(107);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_user_user__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_user__ = __webpack_require__(43);
...
var UsersPage = /** @class */ (function () {
    ...
    UsersPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-users',template:/*ion-inline-start:"/home/clovis/ionic-cms/src/pages/users/users.html"*/'<!--\n  Generated template for the UsersPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>users</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n<ion-refresher (ionRefresh)="doRefresh($event)">\n    <ion-refresher-content></ion-refresher-content>\n  </ion-refresher>\n\n  <ion-list *ngIf="users">\n    <ion-item *ngFor="let user of users"\n    (click)="toUser(user._id)"\n    >\n\n\n      {{ user.username }}\n    </ion-item>\n\n  </ion-list>\n\n  <ion-fab right bottom>\n    <button ion-fab color="secondary">\n      <ion-icon name="add"></ion-icon>\n    </button>\n  </ion-fab>\n\n\n  <ion-fab right bottom>\n    <button ion-fab color="secondary" (click)="toCreateUser()">\n      <ion-icon name="add"></ion-icon>\n    </button>\n  </ion-fab>\n\n</ion-content>\n'/*ion-inline-end:"/home/clovis/ionic-cms/src/pages/users/users.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
